...
import 'package:themes_intro/src/domain/infrastructure/infrastructure.dart';
...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListTileTheme(
          data: appBrightness==Brightness.dark ? appMaterialDarkDrawerListTileThemeData: appMaterialLightDrawerListTileThemeData,
          child: ListView(
          children: [
            ListTile(
